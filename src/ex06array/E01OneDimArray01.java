...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 자바에서는 배열을 객체를 통해 생성하게 된다. 생성된 배열은 힙(heap)영역에 저장되고, 할당되 메모리의 주소값을 반환한다. 그래서
		 * 배열명(배열변수)는 주소값(참조값)을 할당받게 된다. 해당 주소를 통해 배열에 접근한다.
		 */
		...
		/*
		 * 배열의 선언 및 초기화 : 배열은 여러 개의 변수를 사용하기 위해 선언하므로 접근을 위해 일반적으로 반복문 사용 배열명.length :
		 * 해당 배열의 크기를 반환한다. 배열의 크기가 변경되는 경우에 유연하게 사용 가능
		 * 
		 */
		...
		/*
		 * 객체 배열 : 기본 자료형을 저장하는 배열이 아니라, 객체의 참조값을 저장할 용도로 생성하는 배열이다.
		 */
