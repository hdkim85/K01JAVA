...
//				new MessageSendingThread("첫번 째");
//		MessageSendingThread tr2 = 
//				new MessageSendingThread("두번 째");
//		MessageSendingThread tr3 = 
//				new MessageSendingThread("세번 째");
		 ...
		 */
//		MessageSendingThread tr1 = 
//				new MessageSendingThread("첫번 째", Thread.MAX_PRIORITY);
//		MessageSendingThread tr2 = 
//				new MessageSendingThread("두번 째",Thread.NORM_PRIORITY);
//		MessageSendingThread tr3 = 
//				new MessageSendingThread("세번 째",Thread.MIN_PRIORITY);
	
		/*
		 3단계
		 	:static상수 대신에 정수를 사용해도 무방
		 */
		MessageSendingThread tr1 = 
				new MessageSendingThread("첫번 째", 10);
		MessageSendingThread tr2 = 
				new MessageSendingThread("두번 째", 5);
		MessageSendingThread tr3 = 
				new MessageSendingThread("세번 째", 1);
