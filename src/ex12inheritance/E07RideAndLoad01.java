...
public class E07RideAndLoad01 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 호출된다. 즉 아래 부분은 모두 C클래스에 생성된 메소드가 호출된다.
		 */
...
//		ref1.loadMethod(1.1);
		...
		/*
		refId1은 A타입의 참조변수이므로 B타입 혹은 C타입의 참조변수로 참조할
		수 없다. 자식타입의 참조변수로 부모객체를 참조하는 것은 불가능하다
		 */
