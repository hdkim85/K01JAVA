...
/*
 상속(Inheritance)
 	:기존에 정의된 클래스에 메소드와 변수를추가하여 새로운
 	클래스를 정의하는 것을 말한다.
 	부모클래스를 자식클래스가 상속할 떄는 extends 키워드를 사용한다.
 */
...
class Man{
	 ...
	 */
	public Man() {
		System.out.println("Man 클래스 디폴트 생성자 호출 됨");
	}
...
//자식클래스 (하위, 유도, sub) : Man클래스를상속받은회사원 클래스
class BusinessMan extends Man {
	...
	/*
	 ...
	 super()는 부모클래스의생성자를 호출하는 역할을 하게 되며
	...
	public void tellYourInfo() {
		...
		//부모클래스에 정의된 멤버메소드 호출. 상속 받았으므로 호출 가능함.
		tellYourName();
	}
