...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		 * for문의 실행순서 1. 반복을 위한 변수 i를 1로 초기화 2. 조건을 검사 (i가 5이하이면 참) 3. 참일 때, 실행 문장을 실행
		 * 4. 증가(감소)식 실행 5. 조건검사(3,4,5번을 반복 횟수만큼 실행함) 6. 조건이 거짓일 때 for문 종료
		 */
		...
		/*
		 * 시나리오] for 문을 이용하여 1~10 사이의 정수 중 2의 배수의 합을 구하는 프로그램을 작성하시오.
		 */
		...
		/*
		 * for문으로 무한루프 조건을 만들 때 아래와 같이 사용한다. 하지만 무한루프는 주로 while문으로 구현한다.
		 */
...
//		System.out.println("위 for문에서 선언한 변수 j = " + j);
		...
		/*
		 ...
		 사용이 가능하다. 즉, 아래에서 선언한 i는 main함수의 지역 변수가 된다.
		 */
		int i = 0;
		for(;i<=5;i++) {
		...
		/*
		 연습 문제] 구구단을 출력하는 프로그램을 for문으로 작성하시오.
		 */
		
		for(int x=2; x<=9; x++) {
			for(int y=1;y<=9;y++) {
				System.out.printf("%-1dX%-1d=%2d ",x,y,x*y);
			}
			System.out.println();
		}
