...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 5] concat() : 두 개의 문자열을 연결할 때 사용한다. +기호와 동일한 역할을 한다.
		 */
		...
		/*
		 9]format()
		 	 ...
		 	 printf()와 사용법은 동일하고 주로 웹어플리케이션(JSP)를 제작할 때
		 	 사용된다.
		 */
		...
		/*
		 시나리오]주민들옥번호를 indexOf를 사용하여 성별을 구분하는
		 프로그램을 작성하시오.
		 */
		...
		System.out.println(str1.replace("J", "G")); //변경없음
		...
		/*
		 13]split()
		 	...
		 	반환한다. 해당 구분자가 없는 경우에는 크기가 1인 String 배열로
		 	반환한다.
		 */
		 ...
		 /*
		  14] substring()
		  	: 시작인덱스와 끝인덱스 사이의 문자열을 잘라서 반환해 줌.
		  	즉 문자열을 자를 때 사용하는 메소드이다.
		  	사용법 1 : substring(인덱스) -> 이 경우 인덱스부터
		  		문자열의 끝까지 잘라서 반환한다.
		  	사용법 2 : substring(인덱스1, 인덱스2) -> 인덱스에
		  		포함되는 부붑ㄴ만 잘라서 반환한다.
		  */
