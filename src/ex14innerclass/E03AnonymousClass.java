...
/*
 ...
 형식]
 	...
 	개념으로 이해하면 된다. 상속되기 때문에 오버라이딩이 가능하게 된다.
...
public class E03AnonymousClass {
	...
	public static void main(String[] args) {
		 ...
		 * 접근하는 것은 불가능 반드시 다운캐스팅 후 접근해야 한다.
		 */
		...
		/*
		 * Person클래스를 상속받은 익명클래스 정의 및 생성 : Person타입의 인스턴스 변수에 Person을 상속 받은 익명 클래스를 생성해서
		 * 그 주소를 할당한다. 개념적으로 new Person(){}; ==> 익명 extends Person{}; 형태라 생각하면 된다. -이름이
		...
		/*
		 * 부모 타입의 참조변수로 하위객체에서 확장한 멤버에 접근할 수 업으므로 위 부분은 에러가 발생한다.
		 */
		...
		/*
		 ...
		 따라서 익명 클래스는 오버라이딩의 목적으로만 사용해야 한다.
		 */
		/*
		Person anonyTest = new Student("다운캐스팅" , "안돼요") {
			String jumin = "001024";
		};
