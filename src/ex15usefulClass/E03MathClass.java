...
/*
 ...
 - 메소드는 static으로 선언되어 객체 생성없이 사용가능.
 */
public class E03MathClass extends Object {
	...
	public static void main(String[] args) {
		...
		/*
		 반올림 : 무조건 소수점 첫째 자리에서 반올림 처리한다.
		 */
		System.out.println("### 반올림 ###");
		System.out.println("Math.rount : " + Math.round(3.4999));
		System.out.println("Math.rount : " + Math.round(3.54444));
		System.out.println("Math.rount : " + Math.round(-1.4));
		System.out.println("Math.rount : " + Math.round(-1.5));
		System.out.println("Math.rount : " + Math.round(-3.51));
