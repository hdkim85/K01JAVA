...
public class E06Random {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("###난수 생성 1 : seed로 32를 사용");

		Random random1 = new Random(32);
		for (int i = 0; i < 10; i++) {
			/*
			 nextInt()의 인자값 100이 전달되면 0~9사이의
			 난수가 생성
			 */
		...
		System.out.println("###난수 생성3 : 항상 다른 See를 사용");
		...
		System.out.println("###난수 생성 4 : 항상 다른 seed를 사용, nextInt() 인자없음");
