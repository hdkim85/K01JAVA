...
/*=> 기존Object 기반의 FruitBox를 아래와 같이 제네리 클래스로 정의한다.	
	자료형에 해당하는 대분을 대표문자T(Type)으로 교체하고, 객체 생성 시
	자료형을결정하기 위해 "클래스명<T>"형태로 변경한다.
*/
...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 생성되었기 때문에 다른 객체는 저장할 수 없다. 아래코드에서 컴파일
		 에러가 발생되므로 자료형에도 안전한 코드가 된다.
		 */
