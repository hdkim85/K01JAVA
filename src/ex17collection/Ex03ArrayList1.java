...
/*
 ArrayList : List 계열의 컬렉션으로
 	-데이터의 중복 저장 허용.
 	-데이터의 저장 순서 보장
 	-데이터에 접근할 때 iterator() 혹은 get()을 이용
 	-Array라는 이름처럼 '배열'의 특성을 갖고 있어
 		인덱스를 통한 저장 및 접근이 가능
 */
...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		list.add("트와이스");
		list.add(3,"워너원");
//		list.add(5,"소방차ㅋㅋ");//에러발생. 인덱스는 건너 뛸 수 없다.
